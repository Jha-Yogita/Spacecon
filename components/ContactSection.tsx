                  ...
                  <div className="text-center w-full">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com/spacecon_nsut/" target="_blank" rel="noopener noreferrer" className="border-4 border-black bg-zinc-800 hover:bg-red-600 p-6 shadow-[5px_5px_0_#000] transition-all duration-300 group">
                        ...
                        {/* LinkedIn */}
                        <a href="https://www.linkedin.com/company/spaceconnsut/" target="_blank" rel="noopener noreferrer" className="border-4 border-black bg-zinc-800 hover:bg-red-600 p-6 shadow-[5px_5px_0_#000] transition-all duration-300 group">
                          <svg className="w-12 h-12 mx-auto mb-2 fill-white transition-colors" viewBox="0 0 24 24">
                        ...
                        {/* Unstop */}
                        <a href="https://unstop.com/college-fests/spacecon-2026-netaji-subhas-university-of-technology-nsut-delhi-434035" target="_blank" rel="noopener noreferrer" className="border-4 border-black bg-zinc-800 hover:bg-red-600 p-6 shadow-[5px_5px_0_#000] transition-all duration-300 group">
                          <div className="w-12 h-12 mx-auto mb-2 flex items-center justify-center rounded-full bg-white">
                            <span className="mono font-black text-black leading-none" style={{ fontSize: '1.9rem', letterSpacing: '-0.08em', transform: 'translateY(1px)' }}>
                              un
                            </span>
                          </div>
