...
const rulebookUrls: Record<string, string> = {
  ...
  "Graph Madness":
    "https://drive.google.com/file/d/17Ol4LRPKcP0ms2gn-S2V6y73jWw7G9nG/view",
...
const eventsByDay = [
  {
    ...
    events: [
      ...
      { 
        ...
        unstopUrl: "https://unstop.com/competitions/graph-madness-spacecon-2026-netaji-subhas-university-of-technology-nsut-delhi-1628247" 
      },
    ]
  },
  {
