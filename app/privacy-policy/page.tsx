      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Spacecon.</li>
            ...
            <li><strong>Website</strong> refers to Spacecon, accessible from spacecon.org</li>
          ...
          <p>
            By email: <a href="mailto:spacecon@nsut.ac.in" className="text-blue-500 hover:text-blue-400">spacecon@nsut.ac.in</a>
          </p>
        </div>
      </div>
    </div>
